...
powershell -Command "Invoke-WebRequest https://github.com/silentGh0st/NadekoBot/raw/dev/scripts/Latest.bat -OutFile '%FILENAME%'"
...
powershell -Command "Invoke-WebRequest https://github.com/silentGh0st/NadekoBot/raw/dev/scripts/Stable.bat -OutFile '%FILENAME%'"
