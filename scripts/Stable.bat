...
ECHO.
git clone -b master --recursive --depth 1 --progress https://github.com/silentGh0st/NadekoBot.git >nul
...
powershell -Command "Invoke-WebRequest https://github.com/silentGh0st/NadekoBot/raw/dev/src/NadekoBot/_libs/32/libsodium.dll -OutFile '%FILENAME%'"
...
powershell -Command "Invoke-WebRequest https://github.com/silentGh0st/NadekoBot/raw/dev/src/NadekoBot/_libs/32/opus.dll -OutFile '%FILENAME%'"
